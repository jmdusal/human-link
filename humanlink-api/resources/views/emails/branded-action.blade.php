                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <div style="text-align: center; margin: 0 0 32px;">
                                <a href="{{ $actionUrl }}" style="background-color: #2563eb; border-radius: 6px; color: #ffffff; display: inline-block; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; font-size: 14px; font-weight: 600; letter-spacing: 0.02em; padding: 14px 32px; text-decoration: none;">
                                    {{ $actionLabel }}
                                </a>
                            </div>
