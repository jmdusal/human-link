...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Contracts\ActivityLogServiceInterface' => \App\Services\ActivityLog\ActivityLogService::class,
            'App\Contracts\AttendanceServiceInterface' => \App\Services\Attendance\AttendanceService::class,
            'App\Contracts\AuthServiceInterface' => \App\Services\Auth\AuthService::class,
            'App\Contracts\LeaveBalanceServiceInterface' => \App\Services\LeaveBalance\LeaveBalanceService::class,
            'App\Contracts\LeavePolicyServiceInterface' => \App\Services\LeavePolicy\LeavePolicyService::class,
            'App\Contracts\LeaveRequestServiceInterface' => \App\Services\LeaveRequest\LeaveRequestService::class,
            'App\Contracts\LeaveServiceInterface' => \App\Services\Leave\LeaveService::class,
            'App\Contracts\PayrollServiceInterface' => \App\Services\Payroll\PayrollService::class,
            'App\Contracts\PermissionServiceInterface' => \App\Services\Permission\PermissionService::class,
            'App\Contracts\ProjectServiceInterface' => \App\Services\Project\ProjectService::class,
            'App\Contracts\RoleServiceInterface' => \App\Services\Role\RoleService::class,
            'App\Contracts\ScheduleServiceInterface' => \App\Services\Schedule\ScheduleService::class,
            'App\Contracts\StatusServiceInterface' => \App\Services\Status\StatusService::class,
            'App\Contracts\TagServiceInterface' => \App\Services\Tag\TagService::class,
            'App\Contracts\TaskAttachmentServiceInterface' => \App\Services\TaskAttachment\TaskAttachmentService::class,
            'App\Contracts\TaskCommentServiceInterface' => \App\Services\TaskComment\TaskCommentService::class,
            'App\Contracts\TaskServiceInterface' => \App\Services\Task\TaskService::class,
            'App\Contracts\UserServiceInterface' => \App\Services\User\UserService::class,
            'App\Contracts\WorkspaceServiceInterface' => \App\Services\Workspace\WorkspaceService::class,
    ...
    override(\config(), map([
            ...
            'broadcasting.connections.reverb.auth_guards' => 'array',
...
'activitylog.actions.log_activity','activitylog.actions.clean_log','app.name','app.env','app.debug',
...
'broadcasting.connections.reverb.options.useTLS','broadcasting.connections.reverb.auth_guards','broadcasting.connections.reverb.client_options','broadcasting.connections.pusher.driver','broadcasting.connections.pusher.key',
...
'dompdf.options.allowed_remote_hosts','dompdf.options.font_height_ratio','dompdf.options.enable_html5_parser','reverb.default','reverb.servers.reverb.host',
...
'reverb.apps.apps.0.rate_limiting.enabled','reverb.apps.apps.0.rate_limiting.max_attempts','reverb.apps.apps.0.rate_limiting.decay_seconds','reverb.apps.apps.0.rate_limiting.terminate_on_limit','ide-helper.filename',
...
'sanctum.csrf-cookie','telescope','notifications.fetch','notifications.readAll',
'notifications.read','activity-logs.index','users.index','users.managers','users.store',
'users.show','users.update','users.destroy','users.workspace','users.project',
'permissions.index','permissions.store','permissions.update','permissions.destroy','roles.index',
'roles.store','roles.update','roles.destroy','workspaces.index','workspaces.store',
'workspaces.acceptInvitation','workspaces.update','workspaces.destroy','workspaces.show','projects.index',
'projects.store','projects.update','projects.destroy','tasks.index','tasks.store',
'tasks.update','tasks.destroy','tasks.updatePosition','tasks.attachmentsIndex','tasks.storeAttachment',
'tasks.destroyAttachment','taskComments.store','taskComments.update','taskComments.destroy','tags.index',
'tags.store','tags.update','tags.destroy','statuses.index','statuses.store',
'statuses.reorder','statuses.update','statuses.destroy','schedules.index','leave-policies.index',
'leave-policies.store','leave-policies.update','leave-policies.destroy','leave-balances.index','leave-balances.store',
'leave-balances.update','leave-balances.destroy','leaves.index','leave-requests.index','leave-requests.policyOptions',
'leave-requests.store','leave-requests.show','leave-requests.update','leave-requests.approve','leave-requests.reject',
'leave-requests.cancel','leave-requests.destroy','attendances.index','attendances.status','attendances.start',
'attendances.pause','attendances.resume','attendances.end','payrolls.index','payrolls.generate',
'payrolls.generateIndividual','payrolls.generateThirteenthMonth','payrolls.pdf','payrolls.show','payrolls.destroy',
'payroll-deductions.index','payroll-deductions.store','payroll-deductions.update','payroll-deductions.destroy','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'emails.workspace-invitation','emails.workspace-invitation-accepted','payslips.pdf','welcome','laravel-exceptions-renderer::components.badge',
...
'DB_HOST','DB_CONNECTION','DB_PORT','DB_DATABASE','DB_USERNAME',
'DB_PASSWORD','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT','SESSION_PATH',
'SESSION_DOMAIN','SESSION_SECURE_COOKIE','SESSION_SAME_SITE','SANCTUM_STATEFUL_DOMAINS','BROADCAST_CONNECTION',
...
'AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','FRONTEND_URL','REVERB_APP_ID','REVERB_APP_KEY',
'REVERB_APP_SECRET','REVERB_HOST','REVERB_PORT','REVERB_SCHEME','REVERB_SERVER_HOST',
'REVERB_HOST_CLIENT','VITE_REVERB_APP_KEY','VITE_REVERB_HOST','VITE_REVERB_PORT','VITE_REVERB_SCHEME',
'TELESCOPE_ENABLED','TELESCOPE_PATH',);
