...
'session.http_only','session.same_site','session.partitioned','reverb.default','reverb.servers.reverb.host',
...
'reverb.apps.apps.0.rate_limiting.enabled','reverb.apps.apps.0.rate_limiting.max_attempts','reverb.apps.apps.0.rate_limiting.decay_seconds','reverb.apps.apps.0.rate_limiting.terminate_on_limit','telescope.enabled',
...
'sanctum.csrf-cookie','telescope','activity-logs.index','users.index',
'users.store','users.show','users.update','users.destroy','users.workspace',
'users.project','permissions.index','permissions.store','permissions.update','permissions.destroy',
'roles.index','roles.store','roles.update','roles.destroy','workspaces.index',
'workspaces.store','workspaces.acceptInvitation','workspaces.update','workspaces.destroy','workspaces.show',
'projects.index','projects.store','projects.update','projects.destroy','tasks.index',
'tasks.store','tasks.update','tasks.destroy','tasks.updatePosition','tasks.attachmentsIndex',
'tasks.storeAttachment','tasks.destroyAttachment','taskComments.store','taskComments.update','taskComments.destroy',
'tags.index','tags.store','tags.update','tags.destroy','statuses.index',
'statuses.store','statuses.reorder','statuses.update','statuses.destroy','schedules.index',
'leave-policies.index','leave-policies.store','leave-policies.update','leave-policies.destroy','leave-balances.index',
'leave-balances.store','leave-balances.update','leave-balances.destroy','leaves.index','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'emails.workspace-invitation','emails.workspace-invitation-accepted','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
