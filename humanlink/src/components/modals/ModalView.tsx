...
export default function ModalView({ isOpen, onClose, title, data }: ModalViewProps) {
    ...
    return (
        <div className="fixed inset-0 z-[100] bg-white flex flex-col animate-in slide-in-from-bottom duration-500 ease-out">
            ...
            <div className="px-8 md:px-12 py-6 flex justify-between items-center border-b border-slate-50">
                ...
                {/* <button 
                    onClick={onClose}
                    className="group p-3 hover:bg-slate-50 rounded-2xl transition-all border-none bg-transparent cursor-pointer flex items-center gap-3"
                >
                    <span className="text-sm font-bold text-slate-400 group-hover:text-slate-600 transition-colors">Close Profile</span>
                    <div className="bg-slate-100 p-2 rounded-xl group-hover:rotate-90 transition-transform duration-300">
